...
server.use(
    cors({
        ...
        origin:'http://localhost:3111',      //react
      //  origin:'http://localhost:4200',    //angular
        credentials:true,
    })
)

// mongoose.connect('mongodb+srv://Mythili:0aBaXezG4PiUmXjE@atlascluster.roimqdb.mongodb.net/jwt')
...
// if(!valid) res.status(401).send("password not correct")
